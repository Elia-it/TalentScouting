...
class ParsingPornstarsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'parsing:pornstars {page}';
     ...
     * @var string
     */
    protected $description = 'Parsing amateur models data and store it';
    ...
    public function handle()
    {
        ...
        for ($counter = 1; $counter <= $page; $counter++){
            $all_pornstars = $pornhub->getPornstarsByPage('pornstar', $counter);
